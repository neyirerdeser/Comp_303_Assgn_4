...
interface Watchable {
	...
	/*
	 * methods that were in the Watchable Interface in the previous baseline
	 * it helps to have these here again, to keep things clean in the filterStrategy classes especially.
	 */
